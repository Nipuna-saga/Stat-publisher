...
<div id="wrap">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ul class="breadcrumb pull-left">
                            ...
                            <li class="active">MB Message Mediation Statistics</li>
                        </ul>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1>MB Mediation Statistics</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <iframe id="dashboardWidget-1" class="single-column-gadget" src="gadgets/messageChart.jag?t=Now&rtype=Proxy"></iframe>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <iframe id="dashboardWidget-1" class="single-column-gadget" src="gadgets/ackChart.jag?t=Now&rtype=Proxy"></iframe>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        var currentTab = "Message Broker Mediation Statistics";
    </script>
