...
public class ConnectionMessages
{
    ...
    public static void reload()
    {
        ...
        _messages = ResourceBundle.getBundle("org.wso2.andes.server.logging.messages.Connection_logmessages", _currentLocale);
    }


    /**
     * Log a Connection message of the Format:
     * <pre>CON-1001 : Open[ : Client ID : {0}][ : Protocol Version : {1}]</pre>
     * Optional values are contained in [square brackets] and are numbered
     * sequentially in the method call.
     *
     */
    public static LogMessage OPEN(String param1, String param2, boolean opt1, boolean opt2)
    {
