        ...
        <div class="row">
            <div class="col-lg-12">
                <h1>MB Mediation Statistics</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <iframe id="dashboardWidget-1" class="single-column-gadget" src="gadgets/TopicChart.jag?t=Now&rtype=Proxy"></iframe>
                        </div>
                    </div>
...
<!-- gadget iframes -->
                    <div class="row">
                        <div class="col-lg-12">
                            <iframe id="dashboardWidget-1" class="single-column-gadget" src="gadgets/subscribersChart.jag?t=Now&rtype=Proxy"></iframe>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        var currentTab = "Message Broker TOPIC/QUEUE Statistics";
    </script>
