...
<head>
    ...
    <title>BAM Dashboard - MB Mediation Statistics</title>
...
<div id="wrap">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ul class="breadcrumb pull-left">
                            ...
                            <li class="active">MB Mediation Statistics</li>
                        </ul>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1>MB Mediation Statistics</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <iframe id="dashboardWidget-1" class="single-column-gadget" src="gadgets/HeapMemUsageChart.jag?t=Now&rtype=Proxy"></iframe>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <iframe id="dashboardWidget-2" src="gadgets/nonHeapMemChart.jag?t=Now&rtype=Proxy"
                                    class="single-column-gadget"></iframe>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <iframe id="dashboardWidget-2" src="gadgets/cpuLoadAvgChart.jag?t=Now&rtype=Proxy"
                                    class="single-column-gadget"></iframe>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        var currentTab = "Message Broker System Statistics";
    </script>
